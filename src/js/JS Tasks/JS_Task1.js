...
// // name('ddddd'): // return => undefined;

// // const name = (attr, attr2) => {
// //     return attr;
// // };
// // const name = attr => {
// //     return attr * 8 + '';
// // };
// // const name = attr => attr * 8 + '';
...
// // // const getMaxDigit = digit => (digit + "").split('').sort((a,b) => b - a).join("");
...
// // const str = "a1bb2ccc3DDDD4";

// // const getTwiceMatch = (str) => {
// //   const result = {};
...
// //     // item // d
// //     const allChar = splitArray.filter((char) => char === item);

// //     // ||
// //     // &&

// //     if (!result[item] && allChar.length >= 2) {
// //       result[item] = allChar.length;
// //     }
// //   });

// //   return result;
// // };
// // console.log(getTwiceMatch(str)); // {a: 1, 1: '1', b: '2'}
// //////////////////////////////////////////////////////////////////////////////////////////
...
// const list1 = [1123, { name: "Ivan" }, "123123", undefined];
...
const duplicate = (obj) => {
  ...
  Object.keys(obj)
    ...
    .forEach((item, index) => {
      ...
      const newArrayWithoutDubl = Array.from(new Set(item));

      newArrayWithoutDubl.forEach((char) => {
        // Object.values(obj).slice(index + 1).some(elem => elem.includes(char)); // true
        if (
          !Object.values(obj)
            .slice(index + 1)
            .some((elem) => elem.includes(char))
        ) {
          prepareArray.push();
        }
      });
      ...
      return (result[item] = prepareArray);
    });
};
